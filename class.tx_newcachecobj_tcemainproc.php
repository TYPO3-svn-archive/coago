...
class tx_newcachecobj_tcemainproc {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pdfgen/class.tx_newcachecobj_tcemainproc.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pdfgen/class.tx_newcachecobj_tcemainproc.php']);
}
